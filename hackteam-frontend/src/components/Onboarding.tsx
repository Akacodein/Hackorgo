...
export default function Onboarding({
  ...
  const [usernameTouched, setUsernameTouched] = useState(Boolean(me.username));
  ...
  // Suggest a username from whatever's typed as a name, until they
  // start customizing the username field themselves.
  useEffect(() => {
    if (!usernameTouched) setUsername(suggestFromName(name));
