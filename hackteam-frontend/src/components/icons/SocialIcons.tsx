...
export function TwitterGlyph({ className }: IconProps) {
  return (
...
export function LinkedinGlyph({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className}>
      ...
      <text x="12" y="16.5" textAnchor="middle" fontSize="10" fontWeight="700" fill="currentColor" fontFamily="sans-serif">
        in
      </text>
    </svg>
  );
...
export function GoogleGlyph({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className}>
      ...
      <text x="12" y="16" textAnchor="middle" fontSize="12" fontWeight="700" fill="currentColor" fontFamily="sans-serif">
        G
      </text>
    </svg>
  );
